...
class HBNBCommandShowTestCase(unittest.TestCase):
...
class HBNBCommandDestroyTestCase(unittest.TestCase):
...
class HBNBCommandAllTestCase(unittest.TestCase):
...
class HBNBCommandUpdateTestCase(unittest.TestCase):
